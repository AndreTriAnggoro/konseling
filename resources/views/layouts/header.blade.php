          ...
          <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu navbar-dropdown dropdown-menu-right" aria-labelledby="notificationDropdown">
                    <div class="dropdown-header">
                        ...
                        <p class="dropdown-title-text">You have {{ $notifikasiDosenwali->count() }} unread notifications</p>
                    </div>
                    @can('acc-mahasiswa')
                    <div class="dropdown-body">
                        @foreach($notifikasiDosenwali as $notifikasi)
                        <a href="{{ route('notif.dosen') }}">
                        <div class="dropdown-list">
                            <div class="icon-wrapper rounded-circle bg-inverse-primary text-primary">
                                <i class="mdi mdi-alert"></i>
                            </div>
                            <div class="content-wrapper">
                                <small class="name">{{ $notifikasi->mahasiswa->nama }}</small>
                                <small class="content-text">
                                    Permintaan konseling pada {{ $notifikasi->tanggal }},
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu navbar-dropdown dropdown-menu-right" aria-labelledby="messageDropdown">
                ...
                <div class="dropdown-body">
                  ...
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      <img class="profile-img" src="{{ asset('images/profile/female/image_2.png') }}" alt="profile image">
                      <div class="status-indicator rounded-indicator bg-success"></div>
                    </div>
                    <div class="content-wrapper">
                  ...
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      <img class="profile-img" src="{{ asset('images/profile/male/image_3.png')" alt="profile image">
